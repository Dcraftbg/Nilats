...
struct discord_thread_tags { int size;
    struct discord_thread_tag *array;
int realsize; };
...
struct discord_component_items { int size;
...
long discord_thread_tags_from_jsmnf(jsmnf_pair *root, const char *js, struct discord_thread_tags *self); size_t discord_thread_tags_from_json(const char buf[], size_t size, struct discord_thread_tags *self);
...
long discord_component_items_from_jsmnf(jsmnf_pair *root, const char *js, struct discord_component_items *self); size_t discord_component_items_from_json(const char buf[], size_t size, struct discord_component_items *self);
...
jsonbcode discord_thread_tags_to_jsonb(jsonb *b, char buf[], size_t size, const struct discord_thread_tags *self); size_t discord_thread_tags_to_json(char buf[], size_t size, const struct discord_thread_tags *self);
...
jsonbcode discord_component_items_to_jsonb(jsonb *b, char buf[], size_t size, const struct discord_component_items *self); size_t discord_component_items_to_json(char buf[], size_t size, const struct discord_component_items *self);
